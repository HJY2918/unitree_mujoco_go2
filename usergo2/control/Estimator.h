...
public:
    ...
    Estimator(QuadrupedRobot *robotModel, RobotInterface &robot_interface, VecInt4 *contact, Vec4 *phase, double dt);
    // Estimator(QuadrupedRobot *robotModel, RobotInterface &robot_interface, VecInt4 *contact, Vec4 *phase, double dt, Vec18 Qdig, std::string testName);
    ~Estimator();
    Vec3  getPosition();
    Vec3  getVelocity();
