#ifndef USER_BALANCE_CTRL_H
#define USER_BALANCE_CTRL_H

#include <array>
#include <filesystem>
#include <fstream>
#include <string>
#include "BasicUserController.hpp"

namespace fs = std::filesystem;

namespace unitree::common
{
    class UserBalanceCtrl final : public BasicUserController {
    public:
        // cfg
        ExampleCfg cfg;

        // state
        std::array<float, 3> cmd;               // 手柄命令
        std::array<float, 12> jpos_processed;   // 处理后的关节角度
        std::array<float, 12> jvel_processed;   // 处理前的关节角度
...
// class UserBalanceCtrl final: public unitree::common::BasicUserController
//     {
//     public:
//         // cfg
//         ExampleCfg cfg;
